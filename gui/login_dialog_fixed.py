...
class LoginDialog(QDialog):
    ...
    def setup_ui(self):
        ...
        # Logo
        logo_label = QLabel()
        logo_path = get_resource_path(os.path.join("assets", "nextgenlogo.png"))
        ...
        image_path = get_resource_path(os.path.join("assets", "SocietyImage1.jpg"))
        print(f"Looking for society image at: {image_path}")
        ...
        if not self.pixmap.isNull():
            ...
            print(f"Society image not found at: {image_path}")
